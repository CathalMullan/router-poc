//! Tests stolen from `matchit` (MIT AND BSD-3-Clause)
...
fn wildcard() {
    ...
    assert_router_matches!(router, {
        ...
        // FIXME
        // "/search/someth!ng+in+ünìcodé".as_bytes() => {
        //     path: "/search/{query}",
        //     value: 11,
        //     params: {
        //         "query" => "someth!ng+in+ünìcodé".as_bytes()
        //     }
        // }
        // "/search/someth!ng+in+ünìcodé/".as_bytes() => None
        "/user_rustacean" => {
            path: "/user_{name}",
            value: 14,
            params: {
